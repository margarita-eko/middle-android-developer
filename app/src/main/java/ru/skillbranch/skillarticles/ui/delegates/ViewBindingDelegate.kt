...
class ViewBindingDelegate<T: ViewBinding>(
    ...
    fun onCreate(){
        ...
        activity.lifecycle.removeObserver(this) //unregister observer this
    }
...
inline fun <reified T: ViewBinding> Fragment.viewBinding(noinline initializer: (View) -> T) = ViewBindingFragmentDelegate(this,initializer)