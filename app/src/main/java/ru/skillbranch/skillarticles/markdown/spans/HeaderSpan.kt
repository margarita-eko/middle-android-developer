...
class HeaderSpan constructor(
    ...
    private fun Canvas.drawFontLines(
        ...
        //drawLine(0f, lineBaseline + paint.ascent(),width + 0f, lineBaseline + paint.ascent(), Paint().apply { color = Color.BLACK } )
        //drawLine(0f, lineBaseline + paint.descent(),width + 0f, lineBaseline + paint.descent(), Paint().apply { color = Color.BLACK } )
    }
}